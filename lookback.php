    ...
    <div class="default-table full-width" style="width: 1188px; margin: auto; background-color: #FFFFFF; border-radius: 20px;">
      <div style="display: flex;">
        <div class="red-box" style=" margin: 10px 5px 5px 10px;">
          <p><span class="static-text">It's been</span> <span class="dynamic-text"><?php echo $check_1; ?></span> <span class="static-text">days, since we became friends 鉂わ笍</span></p>
        </div>
        <div class="red-box" style="margin: 10px 10px 5px 5px;">
          <p><span class="static-text">You saved </span> <span class="dynamic-text">Tk. <?php echo $check_2; ?></span> <span class="static-text">this year from Daraz!</span></p>
        </div>
      </div>

      <div style="display: flex;">
        <div class="red-box" style="margin: 5px 5px 5px 10px;">
          <p><span class="static-text">You shopped most on the month of<br></span> <span class="dynamic-text"><?php echo $check_3; ?><br></span> <span class="static-text">Could it be your birthday month? <span>馃槣</span></span></p>
        </div>
      ...
      <div style="display: flex;">
        ...
        <div class="blue-box" style="margin: 5px 10px 5px 5px;">
          <div>
            <p><span class="static-text">Your favorite brand was</span> <span class="dynamic-text">"<?php echo $check_7; ?>"</span> <span class="static-text">from DarazMall You must be loving it 鉂わ笍</span></p>
          </div>
        </div>
      </div>
